...
The average degree of malicious nodes (Fig.~\ref{fig:in-atk-degree}) shows that Sybils are on average far more connected than honest nodes, thus influencing positively the outcome of the attack. The reader should mind that malicious nodes avoid making connections between themselves.
