...
\section{Attack}\label{sec:atk}
--Enhancing performance of Sybil attacks with fake bootstrapping--

Dissemination methods: fixed probability epidemic, dandelion, dandelion ++;

Bitcoin apps work on an overlay network, <---- è una cosa che devo dire
Bitcoin overlay network is unknown
