...
Network information is spread through \texttt{addr} messages. These are exchanged upon establishing a connection.


In the first attack scenario, Sybil nodes cannot be on fresh bootstrap and are in network from the start. 

In the second scenario, the network is first created and only then Sybils start to join.
...
simulator and development process
