...
The Sybil attack has two different setting that lead to different results. In the first one, Sybil nodes cannot be on fresh bootstrap and are in network from the start.  In the second, the network is first created and only then Sybils start to join. More can be found in Section~\ref{sec:res}.
